...
@if ($digits)
    ...
    >
        ...
        >
            ...
            <div class="px-4 py-3">
                ...
                <a
                    ...
                    target="_blank"
                    rel="noopener"
                    onclick="window.Tracking && Tracking.event('Contact', 'contact', { content_name: 'WhatsApp Widget' })"
        ...
        <a
            ...
            target="_blank"
            rel="noopener"
            onclick="window.Tracking && Tracking.event('Contact', 'contact', { content_name: 'WhatsApp Floating Button' })"
